...
class PostCartTypes(object):
    ...
    def __init__(self, created_by_id=None, guid=None, height=None, length=None, name=None, offset_locked_wheels=None, width=None):  # noqa: E501
    ...
    def offset_locked_wheels(self, offset_locked_wheels):
        ...
        :type: float
        """
        if offset_locked_wheels is None:
